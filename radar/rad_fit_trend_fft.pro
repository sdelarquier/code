pro	rad_fit_trend_fft, date=date, time=time

clear_page
; rad_fit_read, [20100915,20100916], 'bks', /filter,time=[0500,0500]

trendPTR = rad_fit_trend(date=date, time=time)
...
plot, /xlog, Freq[1:trendSize/2], ABS(trendFFT[1:trendSize/2]) , xrange=[2e-5,1e-4]
