;- Plots a range-phase scatter distribution for a given radar and beam on a given day at midnight +/- 3 hours
; Both radar data and ray tracing are compared
...
pro rad_fit_plot_ionoscat_phase, date, radar, beam, ps=ps, xrange=xrange, yrange=yrange
