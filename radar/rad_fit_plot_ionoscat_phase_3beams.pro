;- Plots a range-phase scatter distribution for a given radar on a given day at midnight +/- 3 hours
; Both radar data and ray tracing are compared for the lowest, middle and highest beam
...
pro rad_fit_plot_ionoscat_phase_3beams, date, radar, ps=ps, xrange=xrange, yrange=yrange
