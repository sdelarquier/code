...
; ;juls = timegen(start=julday(01,01,1983), final=julday(01,01,2013), units='months',step_size=6)
; juls = timegen(start=julday(01,01,2005), final=julday(01,01,2013), units='months',step_size=6)
; caldat, juls, month, day, year
; date = year*10000L+month*100L+day
;  
; for it=0,n_elements(juls)-1 do begin
;  	radarFoVsS, date[it], 'fovs'+strtrim(string(it,format='(I03)'),2), /fillfov, range=[-55,55], /bardate, /legend
...
; endfor
; spawn, 'convert -delay 500 fovs000.png -delay 60 fovs???.png -delay 500 fovs'+strtrim(string(n_elements(juls)-1, format='(I03)'),2)+'.png fovs.gif'
