...
C                          HOURS
C         HEIBEG,       HEIGHT RANGE IN KM; maximal 500 heights, i.e.
...
C	Dip declination (+East, -West)
				CALL FELDG(LATI,LONGI,300.0,BNORTH,BEAST,BDOWN,BABS)
				DIPDEC = ATAN(BEAST/BNORTH)/UMR
...
! Added by Seb (Feb 2011), save daily AP indexes
...
c ----------------------
c End of height range calculations
c ----------------------
